...
#define MASK_LNUMX (LAYER_BIT(LAYER_LNUM) | LAYER_BIT(LAYER_LBASEX))
#define MASK_RNUMX (LAYER_BIT(LAYER_RNUM) | LAYER_BIT(LAYER_RBASEX))
#define MASK_LSYMX (LAYER_BIT(LAYER_LSYM) | LAYER_BIT(LAYER_LBASEX))
#define MASK_RSYMX (LAYER_BIT(LAYER_RSYM) | LAYER_BIT(LAYER_RBASEX))
#define MASK_LCTL  (LAYER_BIT(LAYER_LSYM) | LAYER_BIT(LAYER_LNUM))
#define MASK_LCTLX (LAYER_BIT(LAYER_LSYM) | LAYER_BIT(LAYER_LNUM)    | LAYER_BIT(LAYER_LBASEX))
